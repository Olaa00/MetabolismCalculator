    ...
    private fun validation(weight:String?, height:String?, age:String?):Boolean{
        return when{
            height.isNullOrEmpty() -> {
                Toast.makeText(this, "Height is empty. Enter your height", Toast.LENGTH_LONG).show()
           return false
            }
            weight.isNullOrEmpty() -> {
                Toast.makeText(this, "Weight is empty. Enter your weight", Toast.LENGTH_LONG).show()
                return false
        }
            age.isNullOrEmpty() -> {
                Toast.makeText(this, "Age is empty. Enter your age", Toast.LENGTH_LONG).show()
                return false
            }
